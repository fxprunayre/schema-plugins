...
<xsl:stylesheet version="1.0" xmlns:java="java:org.fao.geonet.util.XslUtil" 
    ...
    <xsl:template mode="iso19115-1-2013" match="gex:EX_BoundingPolygon" priority="20">
        <xsl:param name="schema"/>
        <xsl:param name="edit"/>
      
        <xsl:apply-templates mode="iso19115-1-2013" select="gex:extentTypeCode">
        ...
        <xsl:apply-templates mode="iso19115-1-2013" select="gex:polygon">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
        </xsl:apply-templates>
    </xsl:template>
    ...
    XML in DataManager.
    -->
    <xsl:template mode="iso19115-1-2013" match="gex:polygon" priority="20">
        <xsl:param name="schema"/>
        <xsl:param name="edit"/>
